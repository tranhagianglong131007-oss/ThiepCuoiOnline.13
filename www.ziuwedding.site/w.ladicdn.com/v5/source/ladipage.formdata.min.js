LadiPageScriptV2.prototype.parseFormCheckoutProduct = function(e) {
        ...
        if (1 === o.length) {
            ...
            isEmptyLadiPage(d) || (z.quantity = parseInt(d.value) || z.quantity), r.push(z)
        ...
        if (t.checkValidate(e, !1, null)) {
            ...
            try {
                ...
                }), Q.open("POST", n.const.API_LADISALE_CHECKOUT_PAYMENT), Q.setRequestHeader("Content-Type", "application/json"), Q.send(z), D = {
                    customer_name: _,
                    customer_email: g,
                    customer_phone: f,
                    variants: j,
